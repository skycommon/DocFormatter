...
STRINGS = {
    ...
    "en": {
        ...
        "about_title": "About",
        "cool_sub": "Offline heuristic formatting - messy text to clean docs in one click",
        "about_text": (
            "Doc Formatter v1.0.0\n\n"
